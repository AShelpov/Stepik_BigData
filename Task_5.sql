...
/*Как видно из распределения CTR у объявлений с видеобудет получше чем без видео. Все описательные статистики
  ...
  Так же среднее чуть ближе к медиане в распределении объявлений с видео чем без них.
  На таких статистиках сложно давать какие-либо выводы, но в целом картина плюс минус понятна.
